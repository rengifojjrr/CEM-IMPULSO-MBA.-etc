/* El generador de certificados.
   ...
   1. El motor vive en UN solo archivo (certificados/generador.js?v=2026-08-23-14) y lo montan
...
import { agruparPorDia, claveDelDia, diaEnLetras } from '../../certificados/generador.js?v=2026-08-23-14';
