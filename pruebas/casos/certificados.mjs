/* El generador de certificados.
   ...
   1. El motor vive en UN solo archivo (certificados/generador.js?v=2026-09-03-4) y lo montan
...
import { agruparPorDia, claveDelDia, diaEnLetras } from '../../certificados/generador.js?v=2026-09-03-4';
