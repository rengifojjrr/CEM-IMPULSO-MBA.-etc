...
alter table public.cem_visitas enable row level security;
...
create policy cem_visitas_equipo on public.cem_visitas as permissive for select to authenticated
  using (cem_is_staff());
